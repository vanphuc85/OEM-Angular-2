...
@Component({
  selector: 'app-alert-device',
  templateUrl: './alert-device.component.html',
  styleUrls: ['./alert-device.component.css']
})
export class AlertDeviceComponent extends BasePage implements OnInit {
